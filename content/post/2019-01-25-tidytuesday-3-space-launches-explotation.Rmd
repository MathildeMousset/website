---
title: '#Tidytuesday 3: Space launches explotation'
...
From then, I can use the `month()` function to obtain the month of launch (with the full name of month instead of a number), the `weekdays()` function to obtain the day of the week (begining on the Monday), and the `week()` function to obtain the number of the week in the year.
...
While launches were performed by state agencies for a long time, the pravate sector operates most of the launches nowadays in Europe and in the States.
